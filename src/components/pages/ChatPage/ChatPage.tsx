    ...
    if (message) {
      ...
      if (message.messageType === "file" || message.messageType === "audio") {
        try {
          ...
          const fileType =
            message.messageType === "audio" ? "audio" : "archivo";
            ...
            <>
                    ...
                    <h3 className="text-lg text-gray-600">
                      {currentConversation.type === "private" ? (
                        ...
                        <div className="flex flex-col items-start">
                          ...
                          >
                            Conversando en el grupo{" "}
                            {currentConversation.name || "Sin nombre"}
                          </button>
                          <span className="text-xs text-gray-500">{currentConversation.description}</span>
                        </div>
                      )}
                    </h3>
                  </div>
              ...
              <div className="bg-white border-t border-gray-200">
                ...
                <MessageInput
                  ...
                  placeholder={
                    replyingTo
                      ? `Responder a: ${replyingTo.content.substring(0, 30)}...`
                      : "Escribe un mensaje..."
                  }
                />
              </div>
              ...
              {currentConversation.participants.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-gray-400 mt-1">
                    Usa el botón + para agregar usuarios
                  </p>
                </div>
              ) : (
